...
%
\daimoku{Multipath TCPを用いた \\ データセンターネットワークにおけるショートフロー完結時間の改善}
...
implementation」\url{http://mptcp.info.ucl.ac.be/}} \bibitem{rtt}{Vasudevan, Vijay, et al. "Safe and effective fine-grained TCP
...
\bibitem{mptcp_ana2}{藤居 翔吾, 田崎 創, 関谷 勇司, "MultiPath TCP
